var service_host = '12.12.12.12'
//var service_host = '172.18.0.2'
var auth_details = ''
...
service_host = service_host.replace(/^mongodb:\/\//, '');
...
var database = {
    url: `${auth_details}${connection_details}:${mongo_port}/${mongo_database}`,
